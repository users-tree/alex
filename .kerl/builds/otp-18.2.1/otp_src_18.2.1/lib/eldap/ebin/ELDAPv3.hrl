%% Generated by the Erlang ASN.1 compiler version:4.0.1
...
userIdentity = asn1_NOVALUE, oldPasswd = asn1_NOVALUE, newPasswd = asn1_NOVALUE}). % with extension mark

-record('PasswdModifyResponseValue',{
genPasswd = asn1_NOVALUE}). % with extension mark
