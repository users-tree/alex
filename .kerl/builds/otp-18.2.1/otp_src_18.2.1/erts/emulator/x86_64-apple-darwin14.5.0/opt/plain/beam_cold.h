...
OpCase(i_is_eq_exact_spec_frr):
    { 
    BeamInstr* next;
    PreFetch(1, next);
    EqualExact(r(0), r(0), ClauseFail());
    NextPF(1, next);
    }

OpCase(i_is_ge_spec_fcc):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    IsGreaterEqual(Arg(1), Arg(2), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_is_lt_spec_fcc):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    IsLessThan(Arg(1), Arg(2), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_is_lt_spec_frr):
    { 
    BeamInstr* next;
    PreFetch(1, next);
    IsLessThan(r(0), r(0), ClauseFail());
    NextPF(1, next);
    }
