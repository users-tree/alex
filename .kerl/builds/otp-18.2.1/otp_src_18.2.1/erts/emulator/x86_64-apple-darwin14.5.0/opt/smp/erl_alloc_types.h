 ...
 *       'make_alloc_types' on Thu Dec 31 02:10:07 2015.
 *
 * -----------------------------------------------------------------------
 *
 * 
...
#define ERTS_ALC_N_MAX_A_SHORT_LIVED (69)

/* Type numbers used for std_alloc */
#define ERTS_ALC_N_MIN_A_STANDARD (70)
#define ERTS_ALC_N_MAX_A_STANDARD (108)

/* Type numbers used for ll_alloc */
#define ERTS_ALC_N_MIN_A_LONG_LIVED (109)
#define ERTS_ALC_N_MAX_A_LONG_LIVED (154)

/* Type numbers used for eheap_alloc */
#define ERTS_ALC_N_MIN_A_EHEAP (155)
#define ERTS_ALC_N_MAX_A_EHEAP (158)

/* Type numbers used for ets_alloc */
#define ERTS_ALC_N_MIN_A_ETS (159)
#define ERTS_ALC_N_MAX_A_ETS (167)

/* Type numbers used for fix_alloc */
#define ERTS_ALC_N_MIN_A_FIXED_SIZE (168)
#define ERTS_ALC_N_MAX_A_FIXED_SIZE (177)

/* Type numbers used for binary_alloc */
#define ERTS_ALC_N_MIN_A_BINARY (178)
#define ERTS_ALC_N_MAX_A_BINARY (179)

/* Type numbers used for driver_alloc */
#define ERTS_ALC_N_MIN_A_DRIVER (180)
#define ERTS_ALC_N_MAX_A_DRIVER (193)

/* Type numbers used for test_alloc */
#define ERTS_ALC_N_MIN_A_TEST (194)
#define ERTS_ALC_N_MAX_A_TEST (194)

#define ERTS_ALC_N_MAX (194)
...
#define ERTS_ALC_T_MISC_AUX_WORK (7267)
#define ERTS_ALC_T_THR_Q_SL (7395)
#define ERTS_ALC_T_ASYNC (7523)
#define ERTS_ALC_T_XPORTS_LIST (7651)
#define ERTS_ALC_T_T_THR_PRGR_DATA (7779)
#define ERTS_ALC_T_ETHR_SL (7907)
#define ERTS_ALC_T_SYS_MSG_Q (8019)
#define ERTS_ALC_T_SL_MPATHS (8163)
#define ERTS_ALC_T_AINFO_REQ (8291)
#define ERTS_ALC_T_SCHED_WTIME_REQ (8419)
#define ERTS_ALC_T_GC_INFO_REQ (8547)
#define ERTS_ALC_T_FD_LIST (8675)
#define ERTS_ALC_T_ACTIVE_FD_ARR (8803)
#define ERTS_ALC_T_POLLSET_UPDREQ (8931)
#define ERTS_ALC_T_REG_PROC (9044)
#define ERTS_ALC_T_LINK_LH (9172)
#define ERTS_ALC_T_SUSPEND_MON (9300)
#define ERTS_ALC_T_REG_TABLE (9444)
#define ERTS_ALC_T_FUN_TABLE (9524)
#define ERTS_ALC_T_DIST_TABLE (9700)
#define ERTS_ALC_T_NODE_TABLE (9828)
#define ERTS_ALC_T_MODULE_REFS (9908)
#define ERTS_ALC_T_DCACHE (10084)
#define ERTS_ALC_T_DIST_ENTRY (10212)
#define ERTS_ALC_T_NODE_ENTRY (10340)
#define ERTS_ALC_T_ARG_REG (10452)
#define ERTS_ALC_T_PROC_DICT (10580)
#define ERTS_ALC_T_CALLS_BUF (10708)
#define ERTS_ALC_T_BPD (10852)
#define ERTS_ALC_T_LINEBUF (10980)
#define ERTS_ALC_T_IOQ (11108)
#define ERTS_ALC_T_BITS_BUF (11236)
#define ERTS_ALC_T_DB_NTAB_ENT (11332)
#define ERTS_ALC_T_DDLL_HANDLE (11492)
#define ERTS_ALC_T_NODES_MON (11604)
#define ERTS_ALC_T_RE_HEAP (11748)
#define ERTS_ALC_T_PSD (11860)
#define ERTS_ALC_T_PRTSD (12004)
#define ERTS_ALC_T_ZLIB (12132)
#define ERTS_ALC_T_THR_Q_EL (12260)
#define ERTS_ALC_T_THR_Q (12388)
#define ERTS_ALC_T_PORT_LOCK (12516)
#define ERTS_ALC_T_DRIVER_LOCK (12644)
#define ERTS_ALC_T_ETHR_STD (12772)
#define ERTS_ALC_T_DDLL_PROCESS (12900)
#define ERTS_ALC_T_MONITOR_LH (13012)
#define ERTS_ALC_T_NLINK_LH (13140)
#define ERTS_ALC_T_DB_HEIR_DATA (13252)
#define ERTS_ALC_T_NIF_TRAP_EXPORT (13364)
#define ERTS_ALC_T_PORT_DATA_HEAP (13540)
#define ERTS_ALC_T_FD_ENTRY_BUF (13668)
#define ERTS_ALC_T_PRT_REP_EXIT (13796)
#define ERTS_ALC_T_SYS_BLOCKING (13924)
#define ERTS_ALC_T_ATOM (13973)
#define ERTS_ALC_T_MODULE (14133)
#define ERTS_ALC_T_FUN_ENTRY (14261)
#define ERTS_ALC_T_ATOM_TXT (14357)
#define ERTS_ALC_T_TIMER_SERVICE (14565)
#define ERTS_ALC_T_ATOM_TABLE (14613)
#define ERTS_ALC_T_EXPORT_TABLE (14773)
#define ERTS_ALC_T_MODULE_TABLE (14901)
#define ERTS_ALC_T_TAINT (15029)
#define ERTS_ALC_T_PROC_TABLE (15189)
#define ERTS_ALC_T_PORT_TABLE (15333)
#define ERTS_ALC_T_TIMER_WHEEL (15461)
#define ERTS_ALC_T_ASYNC_DATA (15589)
#define ERTS_ALC_T_DB_TABLES (15685)
#define ERTS_ALC_T_INSTR_INFO (15845)
#define ERTS_ALC_T_SCHDLR_SLP_INFO (15973)
#define ERTS_ALC_T_RUNQS (16101)
#define ERTS_ALC_T_DDLL_ERRCODES (16229)
#define ERTS_ALC_T_PRE_ALLOC_DATA (16357)
#define ERTS_ALC_T_CPUDATA (16485)
#define ERTS_ALC_T_CPU_GRPS_MAP (16613)
#define ERTS_ALC_T_AUX_WORK_TMO (16741)
#define ERTS_ALC_T_MISC_AUX_WORK_Q (16869)
#define ERTS_ALC_T_PROC_INTERVAL (16997)
#define ERTS_ALC_T_THR_Q_LL (17125)
#define ERTS_ALC_T_PROC_LCK_WTR (17253)
#define ERTS_ALC_T_RUNQ_BLNS (17381)
#define ERTS_ALC_T_THR_PRGR_IDATA (17509)
#define ERTS_ALC_T_THR_PRGR_DATA (17637)
#define ERTS_ALC_T_ETHR_LL (17765)
#define ERTS_ALC_T_FP_EXCEPTION (17893)
#define ERTS_ALC_T_LL_MPATHS (18021)
#define ERTS_ALC_T_CODE (18101)
#define ERTS_ALC_T_DB_MS_PSDO_PROC (18245)
#define ERTS_ALC_T_SCHDLR_DATA (18405)
#define ERTS_ALC_T_LL_TEMP_TERM (18533)
#define ERTS_ALC_T_EXPORT (18613)
#define ERTS_ALC_T_DRV_TAB (18789)
#define ERTS_ALC_T_DRV_EV_STATE (18917)
#define ERTS_ALC_T_POLLSET (19045)
#define ERTS_ALC_T_POLL_FDS (19173)
#define ERTS_ALC_T_POLL_RES_EVS (19301)
#define ERTS_ALC_T_FD_STATUS (19429)
#define ERTS_ALC_T_SELECT_FDS (19557)
#define ERTS_ALC_T_FD_TAB (19685)
#define ERTS_ALC_T_CS_PROG_PATH (19813)
#define ERTS_ALC_T_BEAM_REGISTER (19926)
#define ERTS_ALC_T_HEAP (20054)
#define ERTS_ALC_T_OLD_HEAP (20182)
#define ERTS_ALC_T_HEAP_FRAG (20310)
#define ERTS_ALC_T_DB_TABLE (20423)
#define ERTS_ALC_T_DB_SEG (20551)
#define ERTS_ALC_T_DB_SEG_TAB (20679)
#define ERTS_ALC_T_DB_STK (20807)
#define ERTS_ALC_T_DB_TRANS_TAB (20935)
#define ERTS_ALC_T_DB_SEL_LIST (21063)
#define ERTS_ALC_T_DB_DMC_ERROR (21191)
#define ERTS_ALC_T_DB_DMC_ERR_INFO (21319)
#define ERTS_ALC_T_DB_TERM (21447)
#define ERTS_ALC_T_PROC (21592)
#define ERTS_ALC_T_MSG_REF (21720)
#define ERTS_ALC_T_LL_PTIMER (21848)
#define ERTS_ALC_T_HL_PTIMER (21976)
#define ERTS_ALC_T_BIF_TIMER (22104)
#define ERTS_ALC_T_THR_Q_EL_SL (22248)
#define ERTS_ALC_T_MONITOR_SH (22360)
#define ERTS_ALC_T_NLINK_SH (22488)
#define ERTS_ALC_T_DRV_EV_D_STATE (22632)
#define ERTS_ALC_T_DRV_SEL_D_STATE (22760)
#define ERTS_ALC_T_DRV_BINARY (22825)
#define ERTS_ALC_T_BINARY (22953)
#define ERTS_ALC_T_PORT (23146)
#define ERTS_ALC_T_DRV (23274)
#define ERTS_ALC_T_DRIVER (23402)
#define ERTS_ALC_T_DRV_CMD_DATA (23530)
#define ERTS_ALC_T_DRV_CTRL_DATA (23658)
#define ERTS_ALC_T_DRV_CALL_DATA (23786)
#define ERTS_ALC_T_NIF (23914)
#define ERTS_ALC_T_PORT_DATA_LOCK (24042)
#define ERTS_ALC_T_DRV_THR_OPTS (24170)
#define ERTS_ALC_T_DRV_TID (24298)
#define ERTS_ALC_T_DRV_MTX (24426)
#define ERTS_ALC_T_DRV_CND (24554)
#define ERTS_ALC_T_DRV_RWLCK (24682)
#define ERTS_ALC_T_DRV_TSD (24810)
#define ERTS_ALC_T_TEST (24939)
