...
const char* erts_build_flags_CFLAGS = "-Werror=return-type  -O0 -I/Users/z/.kerl/builds/otp-18.2.1/otp_src_18.2.1/erts/x86_64-apple-darwin14.5.0   -D_XOPEN_SOURCE -DERTS_SMP -DHAVE_CONFIG_H -Wall -Wstrict-prototypes -Wmissing-prototypes -Wdeclaration-after-statement -DUSE_THREADS -D_THREAD_SAFE -D_REENTRANT -DPOSIX_THREADS  ";
const char* erts_build_flags_CONFIG_H = "/* x86_64-apple-darwin14.5.0/config.h.  Generated by configure.  */\n\
...
#define ERTS_EMU_CMDLINE_FLAGS \" -O0 -I/Users/z/.kerl/builds/otp-18.2.1/otp_src_18.2.1/erts/x86_64-apple-darwin14.5.0   -D_XOPEN_SOURCE -g  -D_XOPEN_SOURCE -I/Users/z/.kerl/builds/otp-18.2.1/otp_src_18.2.1/erts/x86_64-apple-darwin14.5.0    -DUSE_THREADS -D_THREAD_SAFE -D_REENTRANT -DPOSIX_THREADS  -Werror=return-type  -Wall -Wstrict-prototypes -Wmissing-prototypes -Wdeclaration-after-statement\"\n\
\n\
...
#define HAVE_CLOCK_GET_ATTRIBUTES 1\n\
\n\
...
#define HRTIME_CLOCK_ID SYSTEM_CLOCK\n\
\n\
/* Define as a string of monotonic clock id to use */\n\
#define HRTIME_CLOCK_ID_STR \"SYSTEM_CLOCK\"\n\
\n\
/* define if h_errno is declared (in some way) in a system header file */\n\
#define H_ERRNO_DECLARED 1\n\
\n\
/* Define to monotonic clock id to use */\n\
#define MONOTONIC_CLOCK_ID SYSTEM_CLOCK\n\
\n\
/* Define as a string of monotonic clock id to use */\n\
#define MONOTONIC_CLOCK_ID_STR \"SYSTEM_CLOCK\"\n\
\n\
...
/* Define if you want to implement erts_os_monotonic_time() using mach\n\
   clock_get_time() */\n\
#define OS_MONOTONIC_TIME_USING_MACH_CLOCK_GET_TIME 1\n\
\n\
...
/* Define if you want to implement erts_os_system_time() using gettimeofday()\n\
   */\n\
#define OS_SYSTEM_TIME_GETTIMEOFDAY 1\n\
\n\
