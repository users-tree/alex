...
const char* erts_build_flags_CFLAGS = "-Werror=return-type  -O0 -I/Users/z/.kerl/builds/otp-18.2.1/otp_src_18.2.1/erts/x86_64-apple-darwin14.5.0   -D_XOPEN_SOURCE  -DHAVE_CONFIG_H -Wall -Wstrict-prototypes -Wmissing-prototypes -Wdeclaration-after-statement -DUSE_THREADS -D_THREAD_SAFE -D_REENTRANT -DPOSIX_THREADS  ";
