...
case 8: RVAL = succ(st, var[1], var[3]); break;
case 9: RVAL = succ(st, var[3], var[5]); break;
case 10: RVAL = succ(st, var[4], var[6]); break;
case 11: RVAL = succ(st, var[5], var[7]); break;
case 12: RVAL = smp_mark_target_label(st, var[0]); break;
case 13: RVAL = smp_already_locked(st, var[0]); break;
case 14: RVAL = smp(st); break;
case 15: RVAL = succ(st, var[1], var[2]); break;
case 16: RVAL = succ(st, var[2], var[3]); break;
case 17: RVAL = succ(st, var[0], var[4]); break;
case 18: RVAL = succ2(st, var[0], var[4]); break;
case 19: RVAL = binary_too_big(st, var[1]); break;
case 20: RVAL = should_gen_heap_bin(st, var[0]); break;
case 21: RVAL = no_fpe_signals(st); break;
case 22: RVAL = map_key_sort(st, var[4], var+5); break;
case 23: RVAL = is_empty_map(st, var[0]); break;
case 24: RVAL = literal_is_map(st, var[0]); break;
case 25: RVAL = map_key_sort(st, var[2], var+3); break;
