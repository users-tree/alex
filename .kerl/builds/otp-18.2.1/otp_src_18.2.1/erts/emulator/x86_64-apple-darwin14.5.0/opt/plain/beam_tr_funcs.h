...
case 25: RVAL = gen_has_map_fields(st, var[0], var[1], var[2], var+3); break;
case 26: RVAL = gen_get_map_element(st, var[0], var[1], var[2], var+3); break;
case 27: RVAL = gen_get_map_elements(st, var[0], var[1], var[2], var+3); break;
case 28: RVAL = gen_increment(st, var[2], var[1], var[0], var[3]); break;
case 29: RVAL = gen_increment(st, var[1], var[2], var[0], var[3]); break;
case 30: RVAL = gen_increment_from_minus(st, var[1], var[2], var[0], var[3]); break;
case 31: RVAL = gen_guard_bif1(st, var[0], var[1], var[2], var[3], var[4]); break;
case 32: RVAL = gen_guard_bif2(st, var[0], var[1], var[2], var[3], var[4], var[5]); break;
case 33: RVAL = gen_guard_bif3(st, var[0], var[1], var[2], var[3], var[4], var[5], var[6]); break;
