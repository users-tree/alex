...
OpCase(i_get_map_element_frxr):
    { 
    BeamInstr* next;
    PreFetch(2, next);
    GetMapElement(r(0), xb(Arg(1)), r(0), ClauseFail());
    NextPF(2, next);
    }

OpCase(i_get_map_element_frxx):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    GetMapElement(r(0), xb(Arg(1)), xb(Arg(2)), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_get_map_element_frxy):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    GetMapElement(r(0), xb(Arg(1)), yb(Arg(2)), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_get_map_element_fxxr):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    GetMapElement(xb(Arg(1)), xb(Arg(2)), r(0), ClauseFail());
    NextPF(3, next);
    }
...
OpCase(i_get_map_element_fyxr):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    GetMapElement(yb(Arg(1)), xb(Arg(2)), r(0), ClauseFail());
    NextPF(3, next);
    }
...
OpCase(i_get_map_element_hash_frcIr):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    GetMapElementHash(r(0), Arg(1), Arg(2), r(0), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_get_map_element_hash_frcIx):
    { 
    BeamInstr* next;
    PreFetch(4, next);
    GetMapElementHash(r(0), Arg(1), Arg(2), xb(Arg(3)), ClauseFail());
    NextPF(4, next);
    }

OpCase(i_get_map_element_hash_frcIy):
    { 
    BeamInstr* next;
    PreFetch(4, next);
    GetMapElementHash(r(0), Arg(1), Arg(2), yb(Arg(3)), ClauseFail());
    NextPF(4, next);
    }

OpCase(i_get_map_element_hash_fxcIr):
    { 
    BeamInstr* next;
    PreFetch(4, next);
    GetMapElementHash(xb(Arg(1)), Arg(2), Arg(3), r(0), ClauseFail());
    NextPF(4, next);
    }
...
OpCase(i_get_map_element_hash_fycIr):
    { 
    BeamInstr* next;
    PreFetch(4, next);
    GetMapElementHash(yb(Arg(1)), Arg(2), Arg(3), r(0), ClauseFail());
    NextPF(4, next);
    }
...
OpCase(i_is_eq_exact_spec_frx):
    { 
    BeamInstr* next;
    PreFetch(2, next);
    EqualExact(r(0), xb(Arg(1)), ClauseFail());
    NextPF(2, next);
    }

OpCase(i_is_eq_exact_spec_fry):
    { 
    BeamInstr* next;
    PreFetch(2, next);
    EqualExact(r(0), yb(Arg(1)), ClauseFail());
    NextPF(2, next);
    }

OpCase(i_is_eq_exact_spec_fxx):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    EqualExact(xb(Arg(1)), xb(Arg(2)), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_is_eq_exact_spec_fxy):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    EqualExact(xb(Arg(1)), yb(Arg(2)), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_is_ge_spec_fcx):
    { 
    BeamInstr* next;
    PreFetch(3, next);
...
OpCase(i_is_lt_spec_fcr):
    { 
    BeamInstr* next;
    PreFetch(2, next);
    IsLessThan(Arg(1), r(0), ClauseFail());
    NextPF(2, next);
    }

OpCase(i_is_lt_spec_fcx):
    { 
    BeamInstr* next;
    PreFetch(3, next);
...
OpCase(i_is_lt_spec_frc):
    { 
    BeamInstr* next;
    PreFetch(2, next);
    IsLessThan(r(0), Arg(1), ClauseFail());
    NextPF(2, next);
    }

OpCase(i_is_lt_spec_frx):
    { 
    BeamInstr* next;
    PreFetch(2, next);
    IsLessThan(r(0), xb(Arg(1)), ClauseFail());
    NextPF(2, next);
    }

OpCase(i_is_lt_spec_fxc):
    { 
    BeamInstr* next;
    PreFetch(3, next);
...
OpCase(i_is_lt_spec_fxr):
    { 
    BeamInstr* next;
    PreFetch(2, next);
    IsLessThan(xb(Arg(1)), r(0), ClauseFail());
    NextPF(2, next);
    }

OpCase(i_is_lt_spec_fxx):
    { 
    BeamInstr* next;
    PreFetch(3, next);
...
OpCase(move2_rxyx):
    ...
    PreFetch(1, next);
    tmp_packed1 = Arg(0);
    Move2(r(0), xb(tmp_packed1&BEAM_TIGHT_MASK), yb((tmp_packed1>>BEAM_TIGHT_SHIFT)&BEAM_TIGHT_MASK), xb((tmp_packed1>>(2*BEAM_TIGHT_SHIFT))&BEAM_TIGHT_MASK));
    NextPF(1, next);
    }
...
OpCase(move2_ryxy):
    ...
    PreFetch(1, next);
    tmp_packed1 = Arg(0);
    Move2(r(0), yb(tmp_packed1&BEAM_TIGHT_MASK), xb((tmp_packed1>>BEAM_TIGHT_SHIFT)&BEAM_TIGHT_MASK), yb((tmp_packed1>>(2*BEAM_TIGHT_SHIFT))&BEAM_TIGHT_MASK));
    NextPF(1, next);
    }
...
OpCase(move2_xrxx):
    ...
    PreFetch(1, next);
    tmp_packed1 = Arg(0);
    Move2(xb(tmp_packed1&BEAM_TIGHT_MASK), r(0), xb((tmp_packed1>>BEAM_TIGHT_SHIFT)&BEAM_TIGHT_MASK), xb((tmp_packed1>>(2*BEAM_TIGHT_SHIFT))&BEAM_TIGHT_MASK));
    NextPF(1, next);
    }
...
OpCase(move2_xrxy):
    ...
    PreFetch(1, next);
    tmp_packed1 = Arg(0);
    Move2(xb(tmp_packed1&BEAM_TIGHT_MASK), r(0), xb((tmp_packed1>>BEAM_TIGHT_SHIFT)&BEAM_TIGHT_MASK), yb((tmp_packed1>>(2*BEAM_TIGHT_SHIFT))&BEAM_TIGHT_MASK));
    NextPF(1, next);
    }
...
OpCase(move2_yrxy):
    ...
    PreFetch(1, next);
    tmp_packed1 = Arg(0);
    Move2(yb(tmp_packed1&BEAM_TIGHT_MASK), r(0), xb((tmp_packed1>>BEAM_TIGHT_SHIFT)&BEAM_TIGHT_MASK), yb((tmp_packed1>>(2*BEAM_TIGHT_SHIFT))&BEAM_TIGHT_MASK));
    NextPF(1, next);
    }
...
OpCase(move2_yxrx):
    ...
    PreFetch(1, next);
    tmp_packed1 = Arg(0);
    Move2(yb(tmp_packed1&BEAM_TIGHT_MASK), xb((tmp_packed1>>BEAM_TIGHT_SHIFT)&BEAM_TIGHT_MASK), r(0), xb((tmp_packed1>>(2*BEAM_TIGHT_SHIFT))&BEAM_TIGHT_MASK));
    NextPF(1, next);
    }
...
OpCase(move3_xxxxxx):
    ...
    BeamInstr* next;
    PreFetch(6, next);
    Move3(xb(Arg(0)), xb(Arg(1)), xb(Arg(2)), xb(Arg(3)), xb(Arg(4)), xb(Arg(5)));
    NextPF(6, next);
    }
...
OpCase(move3_xyxyxy):
    ...
    BeamInstr* next;
    PreFetch(6, next);
    Move3(xb(Arg(0)), yb(Arg(1)), xb(Arg(2)), yb(Arg(3)), xb(Arg(4)), yb(Arg(5)));
    NextPF(6, next);
    }
...
OpCase(move3_yxyxyx):
    ...
    BeamInstr* next;
    PreFetch(6, next);
    Move3(yb(Arg(0)), xb(Arg(1)), yb(Arg(2)), xb(Arg(3)), yb(Arg(4)), xb(Arg(5)));
    NextPF(6, next);
    }
