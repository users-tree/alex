...
exports.init = function(cli) {
  ...
  siteConnectionStrings.command("list [name]").usage("[options] [name]").description($("Show your site application settings")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __1(name, options, _) {
  ...
  siteConnectionStrings.command("add [connectionname] [value] [type] [name]").usage("[options] <connectionname> <value> <type> [name]").description($("Add a connection string to your site")).option("--slot <slot>", $("the name of the slot")).option("-c, --connectionname <connectionname>", $("the connection string name")).option("-v, --value <value>", $("the connection string value")).option("-t, --type <type>", $("the connection string type")).option("-s, --subscription <id>", $("the subscription id")).execute(function __2(connectionname, value, type, name, options, _) {
    var parsedSiteName, context, siteConfigurations;
    var __frame = {
      name: "__2",
      line: 69
    };
    return __func(_, this, arguments, __2, 5, __frame, function __$__2() {
      return cli.interaction.promptIfNotGiven($("Connection String Name: "), connectionname, __cb(_, __frame, 1, 39, function ___(__0, __1) {
        connectionname = __1;
        return cli.interaction.promptIfNotGiven($("Connection String Value: "), value, __cb(_, __frame, 2, 30, function ___(__0, __2) {
          value = __2;
          return cli.interaction.chooseIfNotGiven($("Connection String Type: "), $("Getting types"), type, function(cb) {
          ...
          }, __cb(_, __frame, 3, 29, function ___(__0, __3) {
            type = __3;
            ...
            return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 29, 11, function __$__2() {
              return site.doSiteConfigGet(context, __cb(_, __frame, 30, 36, function ___(__0, __4) {
                siteConfigurations = __4;
                siteConfigurations.connectionStrings.push({
                  connectionString: value,
                  name: connectionname,
                  type: type
                });
                return site.doSiteConfigPUT(siteConfigurations, context, __cb(_, __frame, 37, 11, function __$__2() {
                  _();
                }, true));
              }, true));
            }, true));
    ...
    return __func(_, this, arguments, __3, 3, __frame, function __$__3() {
      return cli.interaction.promptIfNotGiven($("Connection String Name: "), connectionname, __cb(_, __frame, 1, 39, function ___(__0, __2) {
        ...
        return (function __$__3(_) {
          ...
          ;
          return cli.interaction.confirm(util.format($("Deleteconnection string %s? [y/n] "), connectionname), __cb(_, __frame, 3, 45, function ___(__0, __3) {
            var __2 = !__3;
            return _(null, __2);
          }, true));
        })(__cb(_, __frame, -115, 18, function ___(__0, __3) {
          return (function __$__3(__then) {
            ...
            return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 16, 11, function __$__3() {
              return site.doSiteConfigGet(context, __cb(_, __frame, 17, 36, function ___(__0, __4) {
                siteConfigurations = __4;
                found = false;
                return (function __$__3(__then) {
                  if (siteConfigurations.connectionStrings) {
                    ...
                    return (function __$__3(__then) {
                      if (found) {
                        return site.doSiteConfigPUT(siteConfigurations, context, __cb(_, __frame, 30, 15, __then, true));
                      }
                       else {
                        __then();
                      }
                  ...
                  if (!found) {
                    return _(new Error(util.format($("Connection string with name \"%s\" does not exist"), connectionname)));
                  }
                  ;
                  _();
                });
  ...
  siteConnectionStrings.command("show [connectionname] [name]").usage("[options] <connectionname> [name]").description($("Show a connection string for your site")).option("--slot <slot>", $("the name of the slot")).option("-c, --connectionname <connectionname>", $("the connection string name")).option("-s, --subscription <id>", $("the subscription id")).execute(function __4(connectionname, name, options, _) {
    var parsedSiteName, context, siteConfigurations, match;
    var __frame = {
      name: "__4",
      line: 161
    };
    return __func(_, this, arguments, __4, 3, __frame, function __$__4() {
      return cli.interaction.promptIfNotGiven($("Connection String Name: "), connectionname, __cb(_, __frame, 1, 39, function ___(__0, __1) {
        ...
        return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 12, 11, function __$__4() {
          return site.doSiteConfigGet(context, __cb(_, __frame, 13, 36, function ___(__0, __2) {
            siteConfigurations = __2;
            match = siteConfigurations.connectionStrings.filter(function(c) {
