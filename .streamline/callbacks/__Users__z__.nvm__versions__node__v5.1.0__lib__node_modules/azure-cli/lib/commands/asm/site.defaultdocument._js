...
exports.init = function(cli) {
  ...
  siteDefaultDocument.command("list [name]").usage("[options] [name]").description($("Show your site default documents")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __1(name, options, _) {
  ...
  siteDefaultDocument.command("add [document] [name]").usage("[options] <document> [name]").description($("Add a site default document (by default, to the end of the list)")).option("--slot <slot>", $("the name of the slot")).option("-d, --document <document>", $("the new default document")).option("-p, --position <position>", $("the position of the new default document")).option("-s, --subscription <id>", $("the subscription id")).execute(function __2(document, name, options, _) {
    var parsedSiteName, context, siteConfigurations;
    var __frame = {
      name: "__2",
      line: 67
    ...
    return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
      return cli.interaction.promptIfNotGiven($("Document: "), document, __cb(_, __frame, 1, 33, function ___(__0, __1) {
        document = __1;
        parsedSiteName = WebsitesClient.parseSiteName(name);
        context = {
          subscription: profile.current.getSubscription(options.subscription).id,
        ...
        return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 12, 11, function __$__2() {
          return site.doSiteConfigGet(context, __cb(_, __frame, 14, 36, function ___(__0, __2) {
            ...
            ;
            return site.doSiteConfigPUT(siteConfigurations, context, __cb(_, __frame, 30, 11, function __$__2() {
              _();
            }, true));
          }, true));
        }, true));
  ...
  siteDefaultDocument.command("delete [document] [name]").usage("[options] <document> [name]").description($("Delete a site default document")).option("--slot <slot>", $("the name of the slot")).option("-d, --document <document>", $("the new default document")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("-s, --subscription <id>", $("the subscription id")).execute(function __3(document, name, options, _) {
    ...
    return __func(_, this, arguments, __3, 3, __frame, function __$__3() {
      return cli.interaction.promptIfNotGiven("Document: ", document, __cb(_, __frame, 1, 33, function ___(__0, __2) {
        document = __2;
        return (function __$__3(_) {
          ...
          ;
          return cli.interaction.confirm(util.format($("Delete default document %s? [y/n] "), document), __cb(_, __frame, 3, 45, function ___(__0, __3) {
            var __2 = !__3;
            return _(null, __2);
          }, true));
            ...
            return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 16, 11, function __$__3() {
              return site.doSiteConfigGet(context, __cb(_, __frame, 17, 36, function ___(__0, __4) {
                ...
                return (function __$__3(__then) {
                  ...
                  if (!found) {
                    return _(new Error(util.format("Default document \"%s\" does not exist.", document)));
                  }
                  ;
                  _();
                });
