...
exports.init = function(cli) {
  ...
  siteDomain.command("list [name]").usage("[options] [name]").description($("Show your site domains")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __1(name, options, _) {
    ...
    return __func(_, this, arguments, __1, 2, __frame, function __$__1() {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 10, 11, function __$__1() {
        return site.doSiteGet(context, __cb(_, __frame, 12, 36, function ___(__0, __1) {
  ...
  siteDomain.command("add [domain] [name]").usage("[options] <dn> [name]").description($("Add a site domain")).option("-d, --dn <dn>", $("the new domain name")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __2(dn, name, options, _) {
    var parsedSiteName, context, siteConfigurations;
    var __frame = {
      name: "__2",
      line: 66
    ...
    return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
      return cli.interaction.promptIfNotGiven($("Domain name: "), dn, __cb(_, __frame, 1, 27, function ___(__0, __1) {
        dn = __1;
        parsedSiteName = WebsitesClient.parseSiteName(name);
        context = {
          subscription: profile.current.getSubscription(options.subscription).id,
        ...
        return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 12, 11, function __$__2() {
          return site.doSiteGet(context, __cb(_, __frame, 14, 36, function ___(__0, __2) {
            ...
            }, __cb(_, __frame, 16, 11, function __$__2() {
              _();
            }, true));
          }, true));
        }, true));
  ...
  siteDomain.command("delete [dn] [name]").usage("[options] <dn> [name]").description($("Delete a site domain")).option("-d, --dn <dn>", $("the domain name")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __3(dn, name, options, _) {
    ...
    return __func(_, this, arguments, __3, 3, __frame, function __$__3() {
      return cli.interaction.promptIfNotGiven($("Domain name: "), dn, __cb(_, __frame, 1, 27, function ___(__0, __2) {
        dn = __2;
        return (function __$__3(_) {
          ...
          ;
          return cli.interaction.confirm(util.format($("Delete domain name %s? [y/n] "), dn), __cb(_, __frame, 3, 45, function ___(__0, __3) {
            var __2 = !__3;
            return _(null, __2);
          }, true));
        })(__cb(_, __frame, -93, 18, function ___(__0, __3) {
          return (function __$__3(__then) {
            ...
            return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 16, 11, function __$__3() {
              return site.doSiteGet(context, __cb(_, __frame, 18, 36, function ___(__0, __4) {
                ...
                return (function __$__3(__then) {
                  if (siteConfigurations.hostNames) {
                    ...
                    return (function __$__3(__then) {
                      if (found) {
                        return site.doSitePUT(context, {
                          hostNames: siteConfigurations.hostNames
                        }, __cb(_, __frame, 30, 15, __then, true));
                      }
                       else {
                        __then();
                      }
                  ...
                  if (!found) {
                    return _(new Error(util.format($("Domain \"%s\" does not exist"), dn)));
                  }
                  ;
                  _();
                });
