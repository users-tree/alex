...
exports.init = function(cli) {
  ...
  siteDomain.command("list [name]").usage("[options] [name]").description($("Show your site handler mappings documents")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __1(name, options, _) {
  ...
  siteDomain.command("add [extension] [processor] [name]").usage("[options] <extension> <processor> [name]").description($("Add a handler mapping")).option("-e, --extension <extension>", $("the handler mapping extension")).option("-p, --processor <processor>", $("the path to the script processor (executable that will process the file given by the extension)")).option("-a, --arguments <arguments>", $("the additional arguments")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __2(extension, processor, name, options, _) {
    ...
    return __func(_, this, arguments, __2, 4, __frame, function __$__2() {
      ...
      return cli.interaction.promptIfNotGiven($("Extension: "), extension, __cb(_, __frame, 10, 34, function ___(__0, __1) {
        extension = __1;
        return cli.interaction.promptIfNotGiven($("Script Processor Path: "), processor, __cb(_, __frame, 11, 34, function ___(__0, __2) {
          processor = __2;
          return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 13, 11, function __$__2() {
            return site.doSiteConfigGet(context, __cb(_, __frame, 15, 36, function ___(__0, __3) {
              siteConfigurations = __3;
              handler = {
              };
              ...
              return site.doSiteConfigPUT(siteConfigurations, context, __cb(_, __frame, 27, 11, function __$__2() {
                _();
              }, true));
            }, true));
          }, true));
  ...
  siteDomain.command("delete [extension] [name]").usage("[options] <extension> [name]").description($("Delete a site handler mapping")).option("-e, --extension <extension>", $("the extension")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __3(extension, name, options, _) {
    ...
    return __func(_, this, arguments, __3, 3, __frame, function __$__3() {
      ...
      return cli.interaction.promptIfNotGiven($("Extension: "), extension, __cb(_, __frame, 10, 34, function ___(__0, __2) {
        extension = __2;
        return (function __$__3(_) {
          ...
          ;
          return cli.interaction.confirm(util.format($("Delete handler mapping with %s extension? [y/n] "), extension), __cb(_, __frame, 12, 45, function ___(__0, __3) {
            var __2 = !__3;
            return _(null, __2);
          }, true));
        })(__cb(_, __frame, -106, 18, function ___(__0, __3) {
          return (function __$__3(__then) {
            ...
            return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 16, 11, function __$__3() {
              return site.doSiteConfigGet(context, __cb(_, __frame, 18, 36, function ___(__0, __4) {
                ...
                return (function __$__3(__then) {
                  ...
                  if (!found) {
                    return _(new Error(util.format($("Handler mapping for extension \"%s\" does not exist"), extension)));
                  }
                  ;
                  _();
                });
