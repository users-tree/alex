...
exports.init = function(cli) {
      ...
      return (function __$__4(__then) {
        if ((!options.subscription && !options.environment)) {
          ...
          return (function __$__4(_) {
            ...
            ;
            return cli.interaction.confirm($("This will clear all account information. Are you sure? [y/n] "), __cb(_, __frame, 7, 59, _, true));
          })(__cb(_, __frame, -116, 18, function ___(__0, __2) {
            shouldClear = __2;
            if (!shouldClear) {
              return _(null);
            }
  ...
  if (cli.isAsmMode()) {
    ...
    account.command("download").description($("Launch a browser to download your publishsettings file")).option("-e, --environment <environment>", $("the publish settings download environment")).option("-r, --realm <realm>", $("the organization's realm, aka 'tenant'")).execute(function __6(options, _) {
      var url;
      var __frame = {
        name: "__6",
        line: 175
