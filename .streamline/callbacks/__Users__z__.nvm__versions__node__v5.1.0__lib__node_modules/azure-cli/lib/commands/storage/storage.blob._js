...
exports.init = function(cli) {
  ...
  function createAzureContainer(container, options, _) {
    var blobService, operation, tips, storageOptions, permission, created, aclOperation;
    var __frame = {
                        ...
                        return (function ___(__then) {
                          (function ___(_) {
                            __tryCatch(_, function __$createAzureContainer() {
                              ...
                              return performStorageOperation(aclOperation, __cb(_, __frame, 21, 10, __then, true), container, null, storageOptions);
                            });
                          })(function ___(e, __result) {
          ...
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$setAzureContainerAcl() {
                ...
                validation.isValidEnumValue(permission, Object.keys(BlobUtilities.BlobContainerPublicAccessType));
                storageOptions.publicAccessLevel = StorageUtil.stringToContainerAccessLevel(permission);
                return performStorageOperation(operation, __cb(_, __frame, 7, 8, __then, true), container, null, storageOptions);
              });
            })(function ___(e, __result) {
  ...
  function createContainerSAS(container, permissions, expiry, options, _) {
    ...
    return __func(_, this, arguments, createContainerSAS, 4, __frame, function __$createContainerSAS() {
      return createSas(container, null, permissions, expiry, options, true, __cb(_, __frame, 1, 4, function __$createContainerSAS() {
        _();
      }, true));
    });
  };
  function createBlobSAS(container, blob, permissions, expiry, options, _) {
    ...
    return __func(_, this, arguments, createBlobSAS, 5, __frame, function __$createBlobSAS() {
      return createSas(container, blob, permissions, expiry, options, false, __cb(_, __frame, 1, 4, function __$createBlobSAS() {
        _();
      }, true));
    });
  };
  function createSas(container, blob, permissions, expiry, options, isOnContainer, _) {
    var blobService, start, output, sharedAccessPolicy, tips;
    var __frame = {
      name: "createSas",
      line: 549
    };
    return __func(_, this, arguments, createSas, 6, __frame, function __$createSas() {
      blobService = getBlobServiceClient(options);
      return interaction.promptIfNotGiven($("Container name: "), container, __cb(_, __frame, 2, 28, function ___(__0, __1) {
        container = __1;
        return (function __$createSas(__then) {
          if (!isOnContainer) {
            return interaction.promptIfNotGiven($("Blob name: "), blob, __cb(_, __frame, 5, 25, function ___(__0, __2) {
              blob = __2;
              __then();
            }, true));
          }
          ...
          ;
        })(function __$createSas() {
          return (function __$createSas(__then) {
            if (!options.policy) {
              return interaction.promptIfNotGiven($("Permissions: "), permissions, __cb(_, __frame, 9, 32, function ___(__0, __3) {
                permissions = __3;
                if (isOnContainer) {
                ...
                ;
                return interaction.promptIfNotGiven($("Expiry: "), expiry, __cb(_, __frame, 16, 27, function ___(__0, __4) {
                  expiry = __4;
            ...
            return (function ___(__then) {
              (function ___(_) {
                __tryCatch(_, function __$createSas() {
  ...
  function uploadAzureBlob(file, container, blobName, options, _) {
    var blobService, blobTypeName, specifiedContainerName, specifiedFileName, specifiedBlobName, specifiedBlobType, storageOptions, properties, force, summary, fsStatus, sizeLimit, tips, blobProperties, propertiesOperation, operation, printer, intervalId, extendOption;
    var __frame = {
              ...
              return fs.stat(specifiedFileName, __cb(_, __frame, 25, 22, function ___(__0, __5) {
                ...
                return (function __$uploadAzureBlob(__then) {
                          ...
                          return (function ___(__then) {
                            (function ___(_) {
                              __tryCatch(_, function __$uploadAzureBlob() {
                                ...
                                startProgress(tips);
                                propertiesOperation = getStorageBlobOperation(blobService, "getBlobProperties");
                                return performStorageOperation(propertiesOperation, __cb(_, __frame, 47, 25, function ___(__0, __6) {
                                  blobProperties = __6;
                                  __then();
                                }, true), specifiedContainerName, specifiedBlobName, storageOptions);
                              });
                          ...
                          if ((blobProperties !== null)) {
                            return (function __$uploadAzureBlob(__then) {
                              if ((blobProperties.blobType !== specifiedBlobType)) {
                                ...
                                return interaction.confirm(util.format($("Do you want to remove the blob %s in container %s? "), specifiedBlobName, specifiedContainerName), __cb(_, __frame, 62, 27, function ___(__0, __8) {
                                  var __7 = !__8;
                                  return (function __$uploadAzureBlob(__then) {
                                    if (__7) {
                                      return _(null);
                  ...
                  return (function ___(__then) {
                        ...
                        return (function ___(__then) {
                          (function ___(_) {
                            __tryCatch(_, function __$uploadAzureBlob() {
                              ...
                              ;
                              return performStorageOperation(operation, __cb(_, __frame, 92, 6, __then, true), specifiedContainerName, specifiedBlobName, specifiedFileName, storageOptions);
                            });
                          })(function ___(e, __result) {
                            __catch(function __$uploadAzureBlob() {
                              if (e) {
                    ...
                    __tryCatch(_, function __$uploadAzureBlob() {
                      extendOption = __.extend(StorageUtil.getStorageAccountOptions(options), {
                        speedSummary: summary
                      });
                      return showAzureBlob(specifiedContainerName, specifiedBlobName, extendOption, __cb(_, __frame, 101, 4, function __$uploadAzureBlob() {
                        _();
                      }, true));
                    });
                  });
          ...
          return (function __$downloadAzureBlob(__then) {
            ...
            return utils.fileExists(dirName, __cb(_, __frame, 28, 15, function ___(__0, __6) {
              ...
              return (function __$downloadAzureBlob(__then) {
                ...
                })(__cb(_, __frame, -935, 18, function ___(__0, __7) {
                  return (function __$downloadAzureBlob(__then) {
                    if (__7) {
  ...
  function startBlobCopy(sourceUri, destContainer, options, _) {
    ...
    return __func(_, this, arguments, startBlobCopy, 3, __frame, function __$startBlobCopy() {
      ...
      return StorageUtil.startAsyncCopy(startCopyParams, sourceUri, destContainer, options, __cb(_, __frame, 2, 16, function __$startBlobCopy() {
        _();
      }, true));
    });
  };
  function showBlobCopy(container, blob, options, _) {
    ...
    return __func(_, this, arguments, showBlobCopy, 3, __frame, function __$showBlobCopy() {
      ...
      return StorageUtil.showAsyncCopy(showCopyParams, container, blob, options, __cb(_, __frame, 6, 16, function __$showBlobCopy() {
        _();
      }, true));
    });
  };
  function stopBlobCopy(container, blob, copyid, options, _) {
    var getStopOperation, stopCopyParams;
    var __frame = {
      name: "stopBlobCopy",
      line: 1091
    };
    return __func(_, this, arguments, stopBlobCopy, 4, __frame, function __$stopBlobCopy() {
      ...
      return StorageUtil.stopAsyncCopy(stopCopyParams, container, blob, copyid, options, __cb(_, __frame, 13, 16, function __$stopBlobCopy() {
        _();
      }, true));
    });
  };
