...
StorageUtil.isNotFoundException = function(e) {
  ...
  return notFoundErrors.some(function(error) {
    return (e.code === error);
  });
};
...
StorageUtil.embedTransferSummary = function(properties, speedSummary) {
  ...
  if (speedSummary) {
    ...
    extendProperties = __.extend(properties, {
            ...
            (function ___(_) {
              __tryCatch(_, function __$operateOnPolicy() {
                return StorageUtil.performStorageOperation(policySettings.getAclOperation, __cb(_, __frame, 4, 27, function ___(__0, __1) {
                  ...
                  return StorageUtil.performStorageOperation(policySettings.setAclOperation, __cb(_, __frame, 8, 16, __then, true), policySettings.resourceName, policies, policySettings.storageOptions);
                }, true), policySettings.resourceName, policySettings.storageOptions);
              });
            })(function ___(e, __result) {
...
function generatePolicy(policyName, start, expiry, permissions) {
  ...
  policy.AccessPolicy.Start = (start ? (((start === StorageUtil.SPACE_PARAMETER) ? StorageUtil.SPACE_PARAMETER : validation.parseDateTime(start))) : "");
  policy.AccessPolicy.Expiry = (expiry ? (((expiry === StorageUtil.SPACE_PARAMETER) ? StorageUtil.SPACE_PARAMETER : validation.parseDateTime(expiry))) : "");
  ...
  if ((permissions === StorageUtil.SPACE_PARAMETER)) {
    policy.AccessPolicy.Permissions = StorageUtil.SPACE_PARAMETER;
  }
   else {
    var sharedAccessPermissions = removeRedundantPermission(permissions);
  ...
  if ((operation === StorageUtil.PolicyOperation.Create)) {
    ...
    if ((index >= 0)) {
      if (__.isDate(newPolicy.AccessPolicy.Start)) {
       ...
       else if ((newPolicy.AccessPolicy.Start === StorageUtil.SPACE_PARAMETER)) {
      ...
      if (__.isDate(newPolicy.AccessPolicy.Expiry)) {
       ...
       else if ((newPolicy.AccessPolicy.Expiry === StorageUtil.SPACE_PARAMETER)) {
        existingPolicies[index].AccessPolicy.Expiry = "";
      }
      
      ;
      if ((newPolicy.AccessPolicy.Permissions === StorageUtil.SPACE_PARAMETER)) {
...
StorageUtil.startAsyncCopy = function StorageUtil_startAsyncCopy__6(startCopyParams, sourceUri, destContainerOrShare, options, _) {
  var isCopyToBlob, source, sourceContainerOrShare, sourceBlobOrFile, embeddedSas, sourceResource, index, sasToken, destBlobOrFile, destOption, destServiceClient, startOperation, tips, copyOp, retry, error, filePath, result;
  var __frame = {
    name: "StorageUtil_startAsyncCopy__6",
    line: 1369
  };
  return __func(_, this, arguments, StorageUtil_startAsyncCopy__6, 4, __frame, function __$StorageUtil_startAsyncCopy__6() {
    isCopyToBlob = isCopyDestinationBlob(startCopyParams.type);
    return getSourceUri(startCopyParams.copyType, options, __cb(_, __frame, 4, 15, function ___(__0, __2) {
      source = __2;
      ...
      ;
      return getSourceSASToken(startCopyParams, sourceContainerOrShare, sourceBlobOrFile, embeddedSas, options, __cb(_, __frame, 39, 17, function ___(__0, __3) {
        sasToken = __3;
        ...
        ;
        return cli.interaction.promptIfNotGiven((isCopyToBlob ? $("Destination container name: ") : $("Destination share name: ")), destContainerOrShare, __cb(_, __frame, 53, 41, function ___(__0, __4) {
          destContainerOrShare = __4;
          ...
          return (function ___(__break) {
            var __more;
            var __loop = __cb(_, __frame, 0, 0, function __$StorageUtil_startAsyncCopy__6() {
              __more = false;
              var __13 = ((retry === true) || (retry === undefined));
              if (__13) {
                return (function ___(__then) {
                  (function ___(_) {
                    __tryCatch(_, function __$StorageUtil_startAsyncCopy__6() {
                      return (function ___(__then) {
                        (function ___(_) {
                          __tryCatch(_, function __$StorageUtil_startAsyncCopy__6() {
                            ...
                            ;
                            return (function __$StorageUtil_startAsyncCopy__6(__then) {
                              if (isCopyToBlob) {
                                retry = false;
                                return StorageUtil.performStorageOperation(startOperation.operation, __cb(_, __frame, 82, 29, function ___(__0, __7) {
                                  copyOp = __7;
                                  __then();
                                }, true), source, destContainerOrShare, destBlobOrFile, startOperation.options);
                              }
                               else {
                                return (function __$StorageUtil_startAsyncCopy__6(_) {
                                  var __1 = ((retry === undefined) && !options.quiet);
                                  if (!__1) {
                                    return _(null, __1);
                                  }
                                  ;
                                  return startCopyParams.checkExistenceOperation(destContainerOrShare, destBlobOrFile, destOption, __cb(_, __frame, 84, 69, _, true));
                                })(__cb(_, __frame, -1368, 17, function ___(__0, __8) {
                                  return (function __$StorageUtil_startAsyncCopy__6(__then) {
                                    if (__8) {
                                      error = new Error();
                                    ...
                                    ;
                                  })(function __$StorageUtil_startAsyncCopy__6() {
                                    retry = false;
                                    filePath = StorageUtil.normalizePath(destBlobOrFile);
                                    result = StorageUtil.fetchBasenameAndDirname(filePath);
                                    return StorageUtil.performStorageOperation(startOperation.operation, __cb(_, __frame, 93, 29, function ___(__0, __9) {
                                      copyOp = __9;
                                      __then();
                                    }, true), source, destContainerOrShare, result.dirname, result.basename, startOperation.options);
                                  });
                                }, true));
                              }
                              ;
                          ...
                          __catch(function __$StorageUtil_startAsyncCopy__6() {
                            if (e) {
                              return (function __$StorageUtil_startAsyncCopy__6(__then) {
                                if (isCopyToBlob) {
                                  return (function __$StorageUtil_startAsyncCopy__6(__then) {
                                    if (StorageUtil.isBlobExistsException(e)) {
                                      return cli.interaction.confirm(util.format($("Do you want to overwrite the existing blob %s in the container %s? (Y/N) "), destBlobOrFile, destContainerOrShare), __cb(_, __frame, 98, 34, function ___(__0, __5) {
                                        retry = __5;
                                  ...
                                  return (function __$StorageUtil_startAsyncCopy__6(__then) {
                                    if (StorageUtil.isFileExistsException(e)) {
                                      return cli.interaction.confirm(util.format($("Do you want to overwrite the existing file %s in the share %s? (Y/N) "), destBlobOrFile, destContainerOrShare), __cb(_, __frame, 103, 34, function ___(__0, __6) {
                                        retry = __6;
...
StorageUtil.showAsyncCopy = function StorageUtil_showAsyncCopy__7(showCopyParams, containerOrShare, blobOrFilePath, options, _) {
  var isCopyToBlob, destOption, blobOrFileProps;
  var __frame = {
    name: "StorageUtil_showAsyncCopy__7",
    line: 1498
  };
  return __func(_, this, arguments, StorageUtil_showAsyncCopy__7, 4, __frame, function __$StorageUtil_showAsyncCopy__7() {
    isCopyToBlob = isCopyDestinationBlob(showCopyParams.type);
    return cli.interaction.promptIfNotGiven((isCopyToBlob ? $("Destination container: ") : $("Destination share: ")), containerOrShare, __cb(_, __frame, 3, 37, function ___(__0, __1) {
      containerOrShare = __1;
      return cli.interaction.promptIfNotGiven((isCopyToBlob ? $("Destination blob: ") : $("Destination file path: ")), blobOrFilePath, __cb(_, __frame, 4, 35, function ___(__0, __2) {
        blobOrFilePath = __2;
        destOption = getDestAccountOptions(options);
        return showCopyParams.getProperties(containerOrShare, blobOrFilePath, destOption, __cb(_, __frame, 7, 39, function ___(__0, __3) {
          blobOrFileProps = __3;
...
StorageUtil.stopAsyncCopy = function StorageUtil_stopAsyncCopy__8(stopCopyParam, containerOrShare, blobOrFilePath, copyid, options, _) {
  var isCopyToBlob, serviceClient, stopOperation, tips, stopOp, filePath, result;
  var __frame = {
    name: "StorageUtil_stopAsyncCopy__8",
    line: 1527
  };
  return __func(_, this, arguments, StorageUtil_stopAsyncCopy__8, 5, __frame, function __$StorageUtil_stopAsyncCopy__8() {
    isCopyToBlob = isCopyDestinationBlob(stopCopyParam.type);
    return cli.interaction.promptIfNotGiven((isCopyToBlob ? $("Destination container: ") : $("Destination share: ")), containerOrShare, __cb(_, __frame, 3, 37, function ___(__0, __1) {
      containerOrShare = __1;
      return cli.interaction.promptIfNotGiven((isCopyToBlob ? $("Destination blob: ") : $("Destination file path: ")), blobOrFilePath, __cb(_, __frame, 4, 35, function ___(__0, __2) {
        blobOrFilePath = __2;
        return cli.interaction.promptIfNotGiven($("Copy ID: "), copyid, __cb(_, __frame, 5, 27, function ___(__0, __3) {
          copyid = __3;
          ...
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$StorageUtil_stopAsyncCopy__8() {
                return (function __$StorageUtil_stopAsyncCopy__8(__then) {
                  if (isCopyToBlob) {
                    return StorageUtil.performStorageOperation(stopOperation.operation, __cb(_, __frame, 21, 27, function ___(__0, __4) {
                      stopOp = __4;
                      __then();
                    }, true), containerOrShare, blobOrFilePath, copyid, stopOperation.options);
                  }
                   else {
                    filePath = StorageUtil.normalizePath(blobOrFilePath);
                    result = StorageUtil.fetchBasenameAndDirname(filePath);
                    return StorageUtil.performStorageOperation(stopOperation.operation, __cb(_, __frame, 25, 27, function ___(__0, __5) {
                      stopOp = __5;
                      __then();
                    }, true), containerOrShare, result.dirname, result.basename, copyid, stopOperation.options);
                  }
                  ;
                })(function __$StorageUtil_stopAsyncCopy__8() {
                  _(null, null, true);
                });
              });
            })(function ___(__e, __r, __cont) {
...
function getSourceUri(type, options, _) {
  var isSourceDefined, source, host, settings, sourceContainerOrShare, sourceBlobOrFilePath, encode;
  var __frame = {
    name: "getSourceUri",
    line: 1667
  };
  return __func(_, this, arguments, getSourceUri, 2, __frame, function __$getSourceUri() {
    if (options.isSourceUriDefined) {
      return _(null, options.sourceUri);
    }
    ;
    isSourceDefined = (options.isSourceBlobDefined || options.isSourceFileDefined);
    return (function __$getSourceUri(__then) {
      if (!isSourceDefined) {
        return cli.interaction.promptIfNotGiven($("Source URI: "), source, __cb(_, __frame, 9, 29, function ___(__0, __1) {
          source = __1;
          __then();
        }, true));
      }
       else {
        settings = getStorageServiceSettings(options);
        return (function __$getSourceUri(__then) {
          if (options.isSourceBlobDefined) {
            ...
            return (function __$getSourceUri(__then) {
              if (!options.sourceContainer) {
                return cli.interaction.promptIfNotGiven($("Source container: "), options.sourceContainer, __cb(_, __frame, 21, 50, function ___(__0, __2) {
                ...
                return (function __$getSourceUri(__then) {
                  if (!options.sourceBlob) {
                    return cli.interaction.promptIfNotGiven($("Source blob: "), options.sourceBlob, __cb(_, __frame, 23, 45, function ___(__0, __3) {
            ...
            return (function __$getSourceUri(__then) {
              if (options.isSourceFileDefined) {
                ...
                if (!host) {
                  return _(new Error($("The file endpoint is invalid")));
                }
                ;
                return (function __$getSourceUri(__then) {
                  if (!options.sourceShare) {
                    return cli.interaction.promptIfNotGiven($("Source share: "), options.sourceShare, __cb(_, __frame, 32, 46, function ___(__0, __4) {
                      options.sourceShare = __4;
                      __then();
                    }, true));
                  }
                   else {
                    return (function __$getSourceUri(__then) {
                      if (!options.sourceBlob) {
                        return cli.interaction.promptIfNotGiven($("Source file path: "), options.sourcePath, __cb(_, __frame, 34, 45, function ___(__0, __5) {
                          options.sourcePath = __5;
                          __then();
                        }, true));
                      }
                       else {
...
function getSourceSASToken(getSourceSASParams, sourceContainerOrShare, sourceBlobOrFilePath, embeddedSas, options, _) {
  var sasToken, isNameDefined, isKeyDefined, isConnectionStringDefined, sourcebServiceClient, aclOperation, permission, criteria, sharedAccessPolicy, filePath, result;
  var __frame = {
    name: "getSourceSASToken",
    line: 1736
  };
  return __func(_, this, arguments, getSourceSASToken, 5, __frame, function __$getSourceSASToken() {
    ...
    return (function __$getSourceSASToken(__then) {
      if (sasToken) {
        ...
        return (function __$getSourceSASToken(__then) {
          if ((!embeddedSas && !options.isSourceUriDefined)) {
            return (function ___(__then) {
              (function ___(_) {
                __tryCatch(_, function __$getSourceSASToken() {
                ...
                __catch(function __$getSourceSASToken() {
                  if (e) {
              ...
              __tryCatch(_, function __$getSourceSASToken() {
                ...
                return StorageUtil.performStorageOperation(aclOperation.operation, __cb(_, __frame, 20, 33, function ___(__0, __1) {
                  permission = __1;
                  ...
                  if ((criteria == permission.publicAccessLevel)) {
                    ...
                    ;
                    if (!sasToken) {
                      return _(new Error($("The source blob or file is not accessible")));
                    }
                    ;
                  }
                  ;
                  __then();
                }, true), sourceContainerOrShare, aclOperation.options);
              });
            });
          }
           else {
